...
[Note: Actual visualization generated by `visualize_chart.py` would appear here in final submission.]
...
**The V - F = 1 invariant enables automated auditing.** This simple property—every vertex except root needs exactly one assurance face—provides a deterministic integrity check. Violations indicate missing assurance or structural malformation.
