...
\begin{enumerate}
    ...
    \item All dependency documents (supporting documents, specs, and guidance) must also be assured with accountable human's signing the associated validations.
\end{enumerate}
\end{enumerate}
