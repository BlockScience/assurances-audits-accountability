...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{vs-code-interface.png}
    \caption{Enter Caption}
    \label{fig:UI for Develop and Write}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{obsidian-interface.png}
    \caption{Enter Caption}
    \label{fig:UI for Read and Review}
\end{figure}
