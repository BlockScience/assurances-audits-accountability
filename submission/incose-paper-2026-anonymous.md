<!--
INCOSE IS 2026 Submission - Anonymous Version
==============================================

TRACEABILITY:
  Source: doc-incose-paper-2026.md (v:doc:incose-paper-2026)
  Derived: 2025-12-30
  Transformation: YAML frontmatter stripped, horizontal rules removed for pandoc

ASSURANCE STATUS:
  The source document passed all verification and validation checks.
  Audit: charts/incose-paper-assurance/incose-paper-assurance-audit-trail.md
  Status: PASS (100% coverage, V-F=1 invariant verified)

ANONYMIZATION:
  - Author information: OMITTED (anonymous submission)
  - Self-citations: NOT APPLICABLE (no prior publications to cite)
  - Approver names: REDACTED in examples

POST-PROCESSING APPLIED:
  1. Stripped YAML frontmatter (lines 1-18 of source)
  2. Removed horizontal rule separators (---)
  3. Ready for pandoc conversion to PDF

TO GENERATE PDF:
  pandoc submission/incose-paper-2026-anonymous.md -o submission/incose-paper-2026-anonymous.pdf \
    --pdf-engine=xelatex \
