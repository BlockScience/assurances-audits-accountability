...
extends: edge
id: e:verification:field-survey-guidance:spec-guidance
name: Verification - guidance-for-field-survey against spec-for-guidance
...
# Verification - guidance-for-field-survey against spec-for-guidance

This verification edge confirms that guidance-for-field-survey v1.0.0 structurally complies with the meta-specification spec-for-guidance.
...
| `id` | Yes | Yes | `v:guidance:field-survey` | PASS |
| `name` | Yes | Yes | "Guidance for Field Survey Documents" | PASS |
| `tags` | Yes | Yes | `[vertex, doc, guidance]` | PASS |
| `version` | Yes | Yes | `1.0.0` | PASS |
| `created` | Yes | Yes | `2025-01-04T23:00:00Z` | PASS |
| `modified` | Yes | Yes | `2025-01-04T23:00:00Z` | PASS |
...
Document: v:guidance:field-survey (Guidance for Field Survey Documents)
...
**Summary:** The guidance-for-field-survey v1.0.0 document is structurally compliant with spec-for-guidance. All required frontmatter fields are present and correctly typed. All required body sections (Purpose, Document Overview, Quality Criteria, Section-by-Section Guidance, Workflow Guidance, Best Practices, Validation vs. Verification) are present. Six quality criteria are defined with proper leveling: scope-clarity, actor-completeness, resource-completeness, relationship-accuracy, boundary-precision, and executive-accessibility.
