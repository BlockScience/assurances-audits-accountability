...
type: edge/signs
extends: edge
id: e:signs:mzargham:guidance-architecture
name: Signs - mzargham attests to guidance-for-architecture
...
# Signs - mzargham attests to guidance-for-architecture

## Signing Event

**Signer:** [[signer-mzargham]]
**Document:** [[guidance-for-architecture]]
