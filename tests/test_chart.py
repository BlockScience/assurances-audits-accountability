...
def _build_sample_kc():
    ...
    with kc.deferred_verification():
        ...
        kc.add_vertex("v:chart:sample", type="chart", name="Sample Chart",
        ...
        kc.add_edge("e:verification:sample", type="verification",
                    vertices={"v:doc:sample", "v:spec:sample"}, name="Sample Verification",
                    status="passing")
        kc.add_edge("e:validation:sample", type="validation",
                    vertices={"v:doc:sample", "v:guidance:sample"}, name="Sample Validation",
                    status="approved", signed_by="Alice")
...
def test_incomplete_subcomplex_fails():
    ...
    incomplete = {
        "v:spec:sample", "v:guidance:sample", "v:doc:sample",
        "e:DocType:sample", "e:verification:sample",
